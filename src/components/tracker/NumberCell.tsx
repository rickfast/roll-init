...
export const NumberCell = ({ initialValue, label, onChange }: Props) => {
    const NumberPopover = ({ multiplier, icon }: { multiplier?: -1, icon: React.ReactNode }) => {
    ...
    return (
        <Button.Group>
            ...
            <Button.GroupSection variant="default" bg="var(--mantine-color-body)" >
                <ClickInput initialValue={initialValue} onChange={(value) => {
                    onChange(value);
                }} />
            </Button.GroupSection>
