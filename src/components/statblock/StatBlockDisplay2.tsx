        ...
        <Card withBorder shadow="sm" radius="md">
            <Stack gap="md">
                ...
                <Box>
                    ...
                    <Group gap="xs">
                        <Badge
                            color={getSizeColor(statBlock.size)}
                            variant="light"
                        >
                            {statBlock.size}
                        </Badge>
                ...
                <Box>
                    ...
                    <SimpleGrid cols={6}>
                        {Object.entries(statBlock.abilityScores).map(
                            ([ability, score]) => (
                                <Paper
                                    key={ability}
                                    p="xs"
                    ...
                    <>
                        ...
                        <Box>
                            ...
                            <Text size="sm">
                                ...
                                {statBlock.spellcasting.ability} (spell save DC{" "}
                                {statBlock.spellcasting.saveDc},
                                {formatModifier(
                    ...
                    statBlock.legendaryActions.length > 0 && (
                        <>
                            ...
                            <Box>
                                ...
                                <Stack gap="sm">
                                    {statBlock.legendaryActions.map(
                                        (action, index) => (
                                            <Box key={index}>
                                                <Text fw={600} span>
                                                    {action.name}.{" "}
