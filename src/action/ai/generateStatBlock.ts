...
export async function generateStatBlock(name: string, cr: number, partial: Partial<StatBlock>, options: { apiKey: string }): Promise<StatBlock> {
    console.log('Generating stat block for:', { name, cr, partial: JSON.stringify(partial) });
